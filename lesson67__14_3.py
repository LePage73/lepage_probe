...
import logging
logging.basicConfig(level=logging.DEBUG, filemode="w", filename="log_test_14_3.log",
...
async def cmd_start(message: types.Message, state: FSMContext):
    kb = kb_('Рассчитать', 'Информация', 'Купить', input_placeholder='Рассчитать?')
